	...
	<aside>
		<div class="current"><?php if(!empty($title)) echo $title; ?></div>
		<div class="social">
		...
		<div class="inner">
			...
			<div class="text">
				...
				<ul>
					...
					<li><a href="#">ABOUT ELLA HOUSE</a></li>
					<li><a href="#">DOWNLOAD BROCHURE</a></li>
					<li><a href="#">EVENTS AT ELLA HOUSE</a></li>
					<li><a href="#">SUSTAINABILITY</a></li>
					<li><a href="#">ELLA HOUSE PHASE TWO</a></li>
					<li><a href="#">FLOORPLANS</a></li>
					<li><a href="#">PRIVACY POLICY</a></li>
					<li><a href="#">TERMS &amp; CONDITIONS</a></li>
				</ul>
				<p>Copyright &copy; 2022 Le Favre Merrion Holdings LtD <span>|</span> All Rights Reserved <span>|</span> Design by <a href="#">FWD</a></p>
				<div class="totop">
					<a href="#top">Top</a>
				</div>
			</div>
	...
	<div class="video-overlay">
        <div class="video-wrap">
            <a class="video-close"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="#fff" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"/></svg></a>
            <div class="video"></div>
        </div>
    </div>
	
	<script src="dist/js.php"></script>
	...
	$z = array_pop($p);
	$z = str_replace('.php','.html',$z);

	$x = str_replace('css.php','bundle.css',$x);
	$x = str_replace('js.php','bundle.js',$x);
